#ifndef GunnsDynEuler132_EXISTS
#define GunnsDynEuler132_EXISTS

/**
@file
@brief    GUNNS Dynamics Euler Angles 132-Sequence declarations

@defgroup  TSM_GUNNS_DYNAMICS_EULER_132  GUNNS Dynamics Euler Angles 132-Sequence
...
@details
PURPOSE:
  (This class defines the conversions between Euler rotations in the 1-3-2 axis sequence and other
   orientation formats.)
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief GUNNS Dynamics Euler Angles 132-Sequence
///
/// @details  This class defines the conversions between Euler rotations in the aerodynamics 1-3-2
///           axis sequence (X, Z, Y or Roll, Yaw, Pitch) and other orientation formats.
////////////////////////////////////////////////////////////////////////////////////////////////////
class GunnsDynEuler132 : public GunnsDynEulerBase
{
    public:
        /// @brief Default constructor.
        GunnsDynEuler132();
        /// @brief Default destructor.
        virtual ~GunnsDynEuler132();
    ...
    private:
        ...
        GunnsDynEuler132(const GunnsDynEuler132& that);
        /// @brief Assignment operator is unavailable since private and not implemented.
        GunnsDynEuler132& operator =(const GunnsDynEuler132& that);
};
