...
@copyright Copyright 2021 United States Government as represented by the Administrator of the
 ...
 (
  ...
  (Philip Trottman) (USA) Feb 2012) (updated for RPCM))
  (Philip Trottman) (LMCO) (Jul 10 2015) (PR 41530 switch fail closed malf shouldn't work if switchcard doesn't have power)
 )
 **************************************************************************************************/
#include "Switch.hh"
#include "math.h"
...
const double Switch::mConductanceLimit = 1.0E15;
...
/////////////////////////////////////////////////////////////////////////////////////////////////
SwitchConfigData::SwitchConfigData(const double defaultSwitchResistance,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Destructs the Switch Config Data Object
////////////////////////////////////////////////////////////////////////////////////////////////////
SwitchConfigData::~SwitchConfigData() {
    // nothing to do
}

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @param[in]    that   (--)  Object to copy
/// @details  Copy constructs this Switch Config data.
////////////////////////////////////////////////////////////////////////////////////////////////////
SwitchConfigData::SwitchConfigData(const SwitchConfigData& that)
:
...
/////////////////////////////////////////////////////////////////////////////////////////////////
void SwitchConfigData::init(const double defaultSwitchResistance,
        const bool overCurrentProtection,
        const bool underVoltProtection,
        const double minVoltage,
        const bool isTwoPortSwitch,
...
///
/// @return     SwitchConfigData&  (--)  Object assigned to.
///
/// @details    Assignment operator for this Switch Configuration Data.
////////////////////////////////////////////////////////////////////////////////////////////////////
SwitchConfigData& SwitchConfigData::operator=(const SwitchConfigData& that)
{
...
/// @details  Constructs the Switch Input data
//////////////////////////////////////////////////////////////////////////////////////////////
SwitchInputData::SwitchInputData(const bool switchMalfFlag,
...
//////////////////////////////////////////////////////////////////////////////////////////////
void SwitchInputData::init(const bool switchMalfFlag,
        const int switchMalfValue,
        const bool switchIsClosed,
        const double posTripLimit,
        const double negTripLimit) {
...
/// @details  Copy constructs this Switch input data.
////////////////////////////////////////////////////////////////////////////////////////////////////
SwitchInputData::SwitchInputData(const SwitchInputData& that)
:
...
///////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Destructs the Switch Input Data Object
///////////////////////////////////////////////////////////////////////////////////////////////
...
/// @param[in]  that   (--)  Object assigned from.
///
/// @return     SwitchInputData&  (--)  Object assigned to.
///
/// @details    Assignment operator for this Switch Input Data.
////////////////////////////////////////////////////////////////////////////////////////////////////
SwitchInputData& SwitchInputData::operator=(const SwitchInputData& that)
{
    /// - Skip attribute assignment if objects are the same
    if (this != &that) {
        mSwitchMalfFlag = that.mSwitchMalfFlag;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details Switch default constructor
////////////////////////////////////////////////////////////////////////////////////////////////////
Switch::Switch()
:
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @param[in] SwitchConfigData  (--) Reference to switch configuration data
/// @param[in] SwitchInputData   (--) Reference to Switch input data
...
/// @details Switch object data initialization
////////////////////////////////////////////////////////////////////////////////////////////////////
void Switch::initialize(const SwitchConfigData& configData,
    ...
    if (configData.mDefaultSwitchResistance > 0.0) {
        ...
        TS_HS_EXCEPTION(TS_HS_WARNING, TS_HS_EPS, "Bad Initialization data", TsInitializationException,
                "Can't have zero or negative switch resistance", "Switch");
    }
    ...
    if (mIsTwoPortSwitch) {
        if (0 == configData.mPortAssigned) {
            TS_HS_EXCEPTION(TS_HS_WARNING, TS_HS_EPS, "Bad Initialization data", TsInitializationException,
                    "Can't have two-port switch output assigned to port 0", "Switch");
        } else {
        ...
        if (configData.mPortAssigned > 0) {
            TS_HS_EXCEPTION(TS_HS_WARNING, TS_HS_EPS, "Bad Initialization data", TsInitializationException,
                    "Can't have port other than 0 assigned to output of non-two port switch", "Switch");
        }
    }

    if (configData.mTripPriority < 1) {
        TS_HS_EXCEPTION(TS_HS_WARNING, TS_HS_EPS, "Bad Initialization data", TsInitializationException,
                "Can't have a trip priority less than 1", "Switch");
    } else {
    ...
    if (!configData.mIsTwoPortSwitch && configData.mTripPriority > 1) {
        TS_HS_EXCEPTION(TS_HS_WARNING, TS_HS_EPS, "Bad Initialization data", TsInitializationException,
                "non two-port switch can't have trip priority greater than 1", "Switch");
    }
    ...
    if (inputData.mPosTripLimit < 0.0) {
        TS_HS_EXCEPTION(TS_HS_WARNING, TS_HS_EPS, "Bad Initialization data", TsInitializationException,
                "Can't have positive trip limit less than zero", "Switch");
    } else {
    ...
    if (inputData.mNegTripLimit > 0.0) {
        TS_HS_EXCEPTION(TS_HS_WARNING, TS_HS_EPS, "Bad Initialization data", TsInitializationException,
                "Can't have negative trip limit greater than zero", "Switch");
    } else {
...
///////////////////////////////////////////////////////////////////////////////////////////////
void Switch::updateSwitchState(const bool powerSupplyValid) {
...
/// a trip condition
///////////////////////////////////////////////////////////////////////////////////////////////
void Switch::updateSwitchFlow(const double currentActual,
...
///////////////////////////////////////////////////////////////////////////////////////////////
void Switch::setExternalTrip(const bool externalTripFlag) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////
void Switch::setPosTripLimit(const double posTripLimit) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////
void Switch::setNegTripLimit(const double negTripLimit) {
...
///////////////////////////////////////////////////////////////////////////////////////////////
void Switch::setSwitchCommandedClosed(const bool switchCommandedClosed) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void Switch::setMalfFailClosed(const bool flag)
{
...
///           arguments resets the malfunction.
////////////////////////////////////////////////////////////////////////////////////////////////////
void Switch::setMalfFailOpen(const bool flag)
{
    mMalfFailOpen = flag;
}
...
///           arguments resets the malfunction.
////////////////////////////////////////////////////////////////////////////////////////////////////
void Switch::setMalfFailResistance(const bool flag, const double value)
{
...
///           arguments resets the malfunction.
////////////////////////////////////////////////////////////////////////////////////////////////////
void Switch::setMalfPosTripSetpoint(const bool flag, const double value)
{
...
///           arguments resets the malfunction.
////////////////////////////////////////////////////////////////////////////////////////////////////
void Switch::setMalfNegTripSetpoint(const bool flag, const double value)
{
