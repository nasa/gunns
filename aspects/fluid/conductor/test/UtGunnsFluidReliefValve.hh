#ifndef UtGunnsFluidReliefValve_EXISTS
#define UtGunnsFluidReliefValve_EXISTS

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @defgroup UT_TSM_GUNNS_FLUID_CONDUCTOR_PRESSURE_RELIEF_VALVE Pressure Relief Valve Unit Tests
/// @ingroup  UT_TSM_GUNNS_FLUID_CONDUCTOR
///
/// @copyright Copyright 2019 United States Government as represented by the Administrator of the
///            National Aeronautics and Space Administration.  All Rights Reserved.
///
/// @details  Unit Tests for the GUNNS Fluid Pressure Relief Valve link model.
/// @{
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief    Inherit from GunnsFluidReliefValve and befriend
///           UtGunnsFluidReliefValve.
///
/// @details  Class derived from the unit under test. It just has a constructor with the same
///           arguments as the parent and a default destructor, but it befriends the unit test case
///           driver class to allow it access to protected data members.
////////////////////////////////////////////////////////////////////////////////////////////////////
class FriendlyGunnsFluidReliefValve : public GunnsFluidReliefValve
{
    public:
        FriendlyGunnsFluidReliefValve();
        virtual ~FriendlyGunnsFluidReliefValve();
        friend class UtGunnsFluidReliefValve;
};
inline FriendlyGunnsFluidReliefValve::FriendlyGunnsFluidReliefValve() :
    GunnsFluidReliefValve() {};
inline FriendlyGunnsFluidReliefValve::~FriendlyGunnsFluidReliefValve() {}

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief    Pressure Relief Valve unit tests.
///
...
///
/// @details  This class provides the unit tests for the GUNNS Fluid Pressure Relief Valve link
///           model within the CPPUnit framework.
////////////////////////////////////////////////////////////////////////////////////////////////////
class UtGunnsFluidReliefValve: public CppUnit::TestFixture
{
    public:
        /// @brief    Default constructs this Pressure Relief Valve unit test.
        UtGunnsFluidReliefValve();
        /// @brief    Default destructs this Pressure Relief Valve unit test.
        virtual ~UtGunnsFluidReliefValve();
    ...
    private:
        CPPUNIT_TEST_SUITE(UtGunnsFluidReliefValve);
        ...
        GunnsFluidReliefValveConfigData*  mConfigData;             /**< (--)            Pointer to the nominal configuration data. */
        ...
        GunnsFluidReliefValveInputData*   mInputData;              /**< (--)            Pointer to nominal input data. */
        FriendlyGunnsFluidReliefValve*    mArticle;                /**< (--)            Pointer to the friendly Pressure Regulator under test. */
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        UtGunnsFluidReliefValve(const UtGunnsFluidReliefValve&);
        ////////////////////////////////////////////////////////////////////////////////////////////
        /// @details  Assignment operator unavailable since declared private and not implemented.
        ////////////////////////////////////////////////////////////////////////////////////////////
        UtGunnsFluidReliefValve& operator =(const UtGunnsFluidReliefValve&);
};
