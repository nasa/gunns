#ifndef UtGunnsGasFan_EXISTS
#define UtGunnsGasFan_EXISTS

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @defgroup UT_TSM_GUNNS_FLUID_POTENTIAL_GAS_FAN   Gas Fan Unit Tests
/// @ingroup  UT_TSM_GUNNS_FLUID_POTENTIAL
///
/// @copyright Copyright 2019 United States Government as represented by the Administrator of the
///            National Aeronautics and Space Administration.  All Rights Reserved.
///
/// @details  Unit Tests for the GUNNS Gas Fan link model.
/// @{
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief    Inherit from GunnsGasFan and befriend UtGunnsGasFan.
///
/// @details  Class derived from the unit under test. It just has a constructor with the same
///           arguments as the parent and a default destructor, but it befriends the unit test case
///           driver class to allow it access to protected data members.
////////////////////////////////////////////////////////////////////////////////////////////////////
class FriendlyGunnsGasFan : public GunnsGasFan
{
    public:
        FriendlyGunnsGasFan();
        virtual ~FriendlyGunnsGasFan();
        friend class UtGunnsGasFan;
};
inline FriendlyGunnsGasFan::FriendlyGunnsGasFan() : GunnsGasFan() {};
inline FriendlyGunnsGasFan::~FriendlyGunnsGasFan() {}

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief    Gas Fan unit tests.
///
/// @details  This class provides the unit tests for the GUNNS Fluid Gas Fan link model
///           within the CPPUnit framework.
////////////////////////////////////////////////////////////////////////////////////////////////////
class UtGunnsGasFan: public CppUnit::TestFixture
{
    public:
        /// @brief    Default constructs this Gas Fan unit test.
        UtGunnsGasFan();
        /// @brief    Default destructs this Gas Fan unit test.
        virtual ~UtGunnsGasFan();
    ...
    private:
        CPPUNIT_TEST_SUITE(UtGunnsGasFan);
        ...
        GunnsGasFanConfigData*       tConfigData;           /**< (--) Pointer to nominal config data */
        ...
        GunnsGasFanInputData*        tInputData;            /**< (--) Pointer to nominal input data */
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        UtGunnsGasFan(const UtGunnsGasFan&);
        ////////////////////////////////////////////////////////////////////////////////////////////
        /// @details  Assignment operator unavailable since declared private and not implemented.
        ////////////////////////////////////////////////////////////////////////////////////////////
        UtGunnsGasFan& operator =(const UtGunnsGasFan&);
};
