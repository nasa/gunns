...
///
/// @details  Default constructs this GUNNS Optimization Test State.
////////////////////////////////////////////////////////////////////////////////////////////////////
//GunnsOptimTestState::GunnsOptimTestState(const unsigned int size)
//    :
//    mState(),
//    mDeltaState(0.0),
//    mCost(0.0),
...
///
/// @returns  GunnsOptimTestState& (--) Reference to this object.
///
/// @details  Assigns this GUNNS Optimization Test state to the values of the given state
///           object.  This only assigns the state vector, and leaves the remaining variables alone.
////////////////////////////////////////////////////////////////////////////////////////////////////
//GunnsOptimTestState& GunnsOptimTestState::operator =(const GunnsOptimTestState& that)
//{
//    if (this != &that) {
...
/// @param[in] that (--) The object to be assigned equal to.
///
/// @returns  GunnsOptimTestConfigData& (--) Reference to this object.
///
/// @details  Assigns this GUNNS Optimization Test configuration data to the values of the
///           given configuration data object.
////////////////////////////////////////////////////////////////////////////////////////////////////
GunnsOptimTestConfigData& GunnsOptimTestConfigData::operator =(const GunnsOptimTestConfigData& that)
{
    if (this != &that) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GunnsOptimTest::setConfigData(const GunnsOptimBaseConfigData* configData)
{
    const GunnsOptimTestConfigData* config = dynamic_cast<const GunnsOptimTestConfigData*>(configData);
    if (config) {
        mConfigData = *config;
    } else {
...
///
/// @details  Initializes this Optimization Test.  Validates the configuration, initializes
...
//        mGradients.push_back(GunnsOptimTestState(mInStatesMaster->size()));
//        mGradients.push_back(GunnsOptimTestState(mInStatesMaster->size()));
//    }
//
//    /// - Create the global state object.
//    mState = new GunnsOptimTestState(mInStatesMaster->size());
//
...
/// @throws   std::runtime_error
///
/// @details  Main update function for the Optimization Test.  Increments the run counters,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//void GunnsOptimTest::propagateState(const double gain)
//{
//    for (unsigned int i=0; i<mInStatesMaster->size(); ++i) {
//
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//void GunnsOptimTest::setGradientStates()
//{
//    for (unsigned int i=0; i<mInStatesMaster->size(); ++i) {
//
//        /// - Compute indexes of the increase and decrease delta-state gradient objects for this
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GunnsOptimTest::assignCost(const double cost, const double runId __attribute__((unused)), const double runIdReturned)
{
    mCost = cost;
    mRunId = runId;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//void GunnsOptimTest::printStates() const
//{
//    if (mVerbosityLevel > 0) {
