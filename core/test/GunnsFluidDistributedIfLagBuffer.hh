...
class GunnsFluidDistributedIfLagBuffer
{
    ...
    public:
        ...
        Distributed2WayBusFluidInterfaceData* mHead1;       /**< (--) Head of buffer 1 for writing by the interface. */
        Distributed2WayBusFluidInterfaceData* mHead2;       /**< (--) Head of buffer 2 for writing by the interface. */
        Distributed2WayBusFluidInterfaceData* mTail1;       /**< (--) Tail of buffer 1 for reading by the interface. */
        Distributed2WayBusFluidInterfaceData* mTail2;       /**< (--) Tail of buffer 2 for reading by the interface. */
    ...
    private:
        Distributed2WayBusFluidInterfaceData mBuffer1[10]; /**< (--) Buffer for direction 1. */
        Distributed2WayBusFluidInterfaceData mBuffer2[10]; /**< (--) Buffer for direction 2. */
