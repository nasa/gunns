...
PROGRAMMERS:
  ((Auto-generated by the GunnsDraw netexport script version beta 13) (2020-01-09 12:05:36.655147))
*/
...
DrawElectConfigData::DrawElectConfigData(const std::string& name, DrawElect* network)
    ...
    testIps(name + ".testIps", &network->netNodeList, false, 25.0, 0.0, 0.0, 56.0, 0.0, 0.5, 0.0, 21.0, 135.0, 1.0e-15, 1, 1, false, 1.0e-4),
    load_2(name + ".load_2", &network->netNodeList, 0.0, 25.0, 50.0),
    short1(name + ".short1", &network->netNodeList),
    converterIn(name + ".converterIn", &network->netNodeList, &network->converterSenseVin, 3, 100.0, 130.0),
