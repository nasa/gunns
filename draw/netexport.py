...
#       replace the link's c##.plug# value with the plug name
#         Note this must happen *after* the maintenance drawing save
for link in links:
            ...
            if '0' == plugType:
                ...
                for socketList in socketLists:
                    if plugType == socketList.attrib['label']:
                        ...
                        link_attribs[plugConfigName] = '&network->' + plugName
                        plugMissing = False
                        break
                if plugMissing:
