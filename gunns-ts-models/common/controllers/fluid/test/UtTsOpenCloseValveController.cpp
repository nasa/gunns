...
int UtTsOpenCloseValveController::TEST_ID = 0;

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Default constructs this Open/Close Valve Controller model unit test.
////////////////////////////////////////////////////////////////////////////////////////////////////
UtTsOpenCloseValveController::UtTsOpenCloseValveController()
    :
    CppUnit::TestFixture(),
    mMinCmdPosition(0.0),
    mMaxCmdPosition(0.0),
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Default destructs this Open/Close Valve Controller model unit test.
////////////////////////////////////////////////////////////////////////////////////////////////////
UtTsOpenCloseValveController::~UtTsOpenCloseValveController()
{
    // nothing to do
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::setUp()
{
    ...
    mPower                  = mHoldPower;
    mArticle                = new FriendlyTsOpenCloseValveController();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::tearDown()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Open/Close Valve Controller model default construction.
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::testDefaultConstruction()
{
    UT_RESULT_FIRST;
    ...
    ASSERT_OPEN_CLOSE_VALVE_CMD_VALUES_EQUAL(false, false, false, mArticle->mCommand);
    ...
    TsOpenCloseValveController* article = new TsOpenCloseValveController();
    delete article;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::testNominalInitialization()
{
    UT_RESULT;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Open/Close Valve Controller model accessors.
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::testAccessors()
{
    UT_RESULT;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Open/Close Valve Controller model modifiers.
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::testModifiers()
{
    UT_RESULT;
    ...
    /// @test    setOpenCommand.
    mArticle->setOpenCommand(true);
    CPPUNIT_ASSERT(mArticle->mCommand.mOpen);
    mArticle->setOpenCommand(false);
    CPPUNIT_ASSERT(!mArticle->mCommand.mOpen);

    /// @test    setCloseCommand.
    mArticle->setCloseCommand(true);
    CPPUNIT_ASSERT(mArticle->mCommand.mClose);
    mArticle->setCloseCommand(false);
    CPPUNIT_ASSERT(!mArticle->mCommand.mClose);
    ...
    for (int i = 0; i < 2; ++i) {
        for (int j = 0; j < 2; ++j) {
            for (int k = 0; k < 2; ++k) {
                ...
                const bool open = static_cast<bool>(j);
                const bool close = static_cast<bool>(k);
                TsOpenCloseValveCmd expected(enable, open, close);
                mArticle->setCommand(expected);
                ASSERT_OPEN_CLOSE_VALVE_CMD_EQUAL(expected, mArticle->mCommand);
            }
        }
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Open/Close Valve Controller model update state (nominal).
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::testUpdateNominal()
{
    UT_RESULT;
    ...
    {
        /// @test    update with open command, nominal position and no faults.
        mArticle->initialize(*mConfig, *mInput, mName);
        const double expectedP       = mArticle->getPosition() + mCmdScale * mRefCmd * mTimeStep;
        const double expectedW       = mMovePower;
        mArticle->setSupplyVoltageFlag(true);
        mArticle->setCommand(TsOpenCloseValveCmd(true, true, false));
        ...
        /// @test    update with close command, nominal position and no faults.
        mArticle->initialize(*mConfig, *mInput, mName);
        const double expectedP       = mArticle->getPosition() - mCmdScale * mRefCmd * mTimeStep;
        const double expectedW       = mMovePower;
        mArticle->setSupplyVoltageFlag(true);
        mArticle->setCommand(TsOpenCloseValveCmd(true, false, true));
        mArticle->update(mTimeStep);
        const double returnedP       = mArticle->getPosition();
        const double returnedW       = mArticle->getPower();
        CPPUNIT_ASSERT_DOUBLES_EQUAL(expectedP, returnedP, mTolerance);
    ...
    /// todo: @test    update without eot interruption

    UT_PASS;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Open/Close Valve Controller model update state (off-nominal).
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::testUpdateOffNominal()
{
    UT_RESULT;
...

    {
        ...
        mArticle->mLatch               = TsPoweredValveController::LATCHING;
        mArticle->setSupplyVoltageFlag(true);
        mArticle->setCommand(TsOpenCloseValveCmd(false, true, false));
        mArticle->update(mTimeStep);
        const double returnedP         = mArticle->getPosition();
        const double returnedW         = mArticle->getPower();
        CPPUNIT_ASSERT(!mArticle->mEnabledFlag);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Open/Close Valve Controller model update state (malfunctions).
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::testUpdateMalfunctions()
{
    UT_RESULT;

    {
        ...
        mArticle->update(mTimeStep);
        const double returnedW            = mArticle->getPower();
        CPPUNIT_ASSERT_DOUBLES_EQUAL(mCmdPosition,
        mArticle->getPosition(), mTolerance);
        CPPUNIT_ASSERT_DOUBLES_EQUAL(expectedW,               returnedW,               mTolerance);
    } {
        ...
        mArticle->mManualPositionFlag     = true;
        const double expected = mArticle->mCmdPosition;
        mArticle->update(mTimeStep);
        const double returned = mArticle->getPosition();
        CPPUNIT_ASSERT_DOUBLES_EQUAL(expected,                returned,                mTolerance);
    } {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Open/Close Valve Controller model initialization exceptions.
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsOpenCloseValveController::testInitializationExceptions()
{
    UT_RESULT;

    /// - Default construct a test article.
    TsOpenCloseValveController article;
