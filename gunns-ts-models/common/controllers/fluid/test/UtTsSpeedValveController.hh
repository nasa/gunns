#ifndef UtTsSpeedValveController_EXISTS
#define UtTsSpeedValveController_EXISTS

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @defgroup  UT_TSM_CONTROLLERS_TsSpeedValveController  Speed Valve Controller Unit Tests
/// @ingroup   UT_TSM_CONTROLLERS
///
/// @copyright Copyright 2019 United States Government as represented by the Administrator of the
///            National Aeronautics and Space Administration.  All Rights Reserved.
///
/// @details   Unit Tests for the Speed Valve Controller model.
///
///@{
///////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief    Inherit from TsSpeedValveController and befriend UtTsSpeedValveController.
///
/// @details  Class derived from the unit under test. It just has a constructor with the same
///           arguments as the parent and a default destructor, but it befriends the unit test case
///           driver class to allow it access to protected data members.
////////////////////////////////////////////////////////////////////////////////////////////////////
class FriendlyTsSpeedValveController : public TsSpeedValveController
{
    public:
        FriendlyTsSpeedValveController();
        virtual ~FriendlyTsSpeedValveController();
        friend class UtTsSpeedValveController;
};
inline FriendlyTsSpeedValveController::FriendlyTsSpeedValveController() : TsSpeedValveController() {};
inline FriendlyTsSpeedValveController::~FriendlyTsSpeedValveController() {}

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief    Valve Controller unit tests.
///
/// @details  This class provides the unit tests for the Speed Valve Controller model within the
///           CPPUnit framework.
////////////////////////////////////////////////////////////////////////////////////////////////////
class UtTsSpeedValveController : public CppUnit::TestFixture
{
    public:
        /// @brief    Default constructs this Speed Valve Controller unit test.
        UtTsSpeedValveController();
        /// @brief    Default destructs this Speed Valve Controller unit test.
        virtual ~UtTsSpeedValveController();
    ...
    private:
        CPPUNIT_TEST_SUITE(UtTsSpeedValveController);
        ...
        FriendlyTsSpeedValveController*     mArticle;                 /**< (--)     Pointer to article under test. */
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        UtTsSpeedValveController(const UtTsSpeedValveController&);
        ////////////////////////////////////////////////////////////////////////////////////////////
        /// @details  Assignment operator unavailable since declared private and not implemented.
        ////////////////////////////////////////////////////////////////////////////////////////////
        UtTsSpeedValveController& operator =(const UtTsSpeedValveController&);
};
