...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Default constructs this Toggle Valve Assembly model unit test.
////////////////////////////////////////////////////////////////////////////////////////////////////
UtTsToggleValveAssembly::UtTsToggleValveAssembly()
    :
    CppUnit::TestFixture(),
    cController(),
    cSensorOpen(),
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Default destructs this Toggle Valve Assembly model unit test.
////////////////////////////////////////////////////////////////////////////////////////////////////
UtTsToggleValveAssembly::~UtTsToggleValveAssembly()
{
    // nothing to do
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsToggleValveAssembly::setUp()
{
    ...
    tName                = "Test";
    tArticle             = new FriendlyTsToggleValveAssembly();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsToggleValveAssembly::tearDown()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Toggle Valve Assembly model construction of configuration and input data.
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsToggleValveAssembly::testConfigAndInput()
{
    std::cout << "................................................................................";
    std::cout << "\n.Toggle Valve Assembly 01: Configuration And Input Data Test............";

    /// @test    Configuration data default construction.
    TsToggleValveAssemblyConfigData defaultConfig;
    ...
    CPPUNIT_ASSERT(TsToggleValveController::LATCHING == defaultConfig.mController.mLatch);
    ...
    TsToggleValveAssemblyInputData  defaultInput;
    ...
    TsToggleValveAssemblyConfigData copyConfig(*tConfig);
    ...
    TsToggleValveAssemblyInputData   copyInput(*tInput);
    ...
    TsToggleValveAssemblyConfigData assignConfig;
    ...
    TsToggleValveAssemblyInputData assignInput;
    assignInput = *tInput;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Toggle Valve Assembly model default construction.
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsToggleValveAssembly::testDefaultConstruction()
{
    std::cout << "\n.Toggle Valve Assembly 02: Default Construction Test....................";
    ...
    TsToggleValveAssembly* article = new TsToggleValveAssembly();
    delete article;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Toggle Valve Assembly model nominal initialization without exceptions.
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsToggleValveAssembly::testNominalInitialization()
{
    std::cout << "\n.Toggle Valve Assembly 03: Nominal Initialization Test..................";
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsToggleValveAssembly::testInitializationFailure()
{
    std::cout << "\n.Toggle Valve Assembly 04: Initialization Failure Test..................";
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Toggle Valve Assembly model accessors.
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsToggleValveAssembly::testAccessors()
{
    std::cout << "\n.Toggle Valve Assembly 05: Accessors Test...............................";
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Toggle Valve Assembly model modifiers.
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsToggleValveAssembly::testModifiers()
{
    std::cout << "\n.Toggle Valve Assembly 06: Modifiers Test...............................";
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @details  Tests for Toggle Valve Assembly model update state (nominal).
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtTsToggleValveAssembly::testUpdateNominal()
{
    std::cout << "\n.Toggle Valve Assembly 07: Update State Nominal Test....................";
    ...
    tArticle->update(true, true, false, tTimeStep);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, tArticle->mController.getPosition(), DBL_EPSILON);
    CPPUNIT_ASSERT(!tArticle->getOpenSensed());
    CPPUNIT_ASSERT( tArticle->getCloseSensed());

    tArticle->update(true, true, true, tTimeStep);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, tArticle->mController.getPosition(), DBL_EPSILON);
    CPPUNIT_ASSERT( tArticle->getOpenSensed());
    CPPUNIT_ASSERT(!tArticle->getCloseSensed());
