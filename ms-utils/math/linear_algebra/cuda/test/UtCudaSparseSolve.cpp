...
////////////////////////////////////////////////////////////////////////////////////////////////////
UtCudaSparseSolve::UtCudaSparseSolve()
    :
    tArticle()
{
    //do nothing
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtCudaSparseSolve::tearDown()
{
    //do nothing
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtCudaSparseSolve::testNormalSolution()
{
    std::cout << "\n -----------------------------------------------------------------------------";
    std::cout << "\n UtCudaSparseSolve ..... 01: testNormalSolution .....................";
    ...
    /// - Note that the cusolverSpDcsrlsvchol gives the wrong answer for a 1-row system.
...
//    CPPUNIT_ASSERT_DOUBLES_EQUAL(b1[0] / A1[0], x1[0], 10.0 * DBL_EPSILON);
//    delete[] b1;
//    delete[] x1;
//    delete[] A1;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtCudaSparseSolve::testUnConditioned()
{
    std::cout << "\n UtCudaSparseSolve ..... 02: testUnConditioned ......................";
    ...
    CPPUNIT_ASSERT_THROW(tArticle.Solve(A, b, x, 2), TsNumericalException);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtCudaSparseSolve::testSingular()
{
    std::cout << "\n UtCudaSparseSolve ..... 03: testSingular ...........................";
    ...
    double b[3] = {0.1, 2.1, 0.0};

    tArticle.Decompose(A, 3);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtCudaSparseSolve::testDecompUnderflow()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void UtCudaSparseSolve::testPosOffDiagSolution()
{
    std::cout << "\n UtCudaSparseSolve ..... 05: testPosOffDiagSolution .................";
