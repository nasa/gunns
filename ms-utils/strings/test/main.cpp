////////////////////////////////////////////////////////////////////////////////////////////////////
/// @defgroup  UT_UTILITIES_STRINGS Strings Utilities Unit Tests
/// @ingroup   UT_UTILITIES
/// @copyright Copyright 2019 United States Government as represented by the Administrator of the
///            National Aeronautics and Space Administration.  All Rights Reserved.
/// @details   Unit test classes for strings utilities.
////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main(int argc, char** argv) {
    ...
    runner.addTest(UtStrings::suite());
    ...
    std::ofstream xmlFileOut("ts-models_ms-utils_stringsTestResults.xml");
