...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 14 Expected Conservation Errors
#===============================================================================================
class TestOverflow14err(Test):
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow14err, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow14err, self).setup()
    ...
    def checkNodesFinalState(self):
       ...
       self.testLT(final_total_mass     - self.total_mass,     -1.0E-5, " expected mass error ::")
       self.testLT(final_total_enthalpy - self.total_enthalpy,   -10.0, " expected enthalpy error ::")
       self.testGT(final_total_mass_N2  - self.total_mass_N2,   1.0e-4, " expected mass N2 error ::")
       self.testGT(final_total_mass_O2  - self.total_mass_O2,   1.0e-6, " expected mass O2 error ::")
       self.testLT(final_total_mass_H2O - self.total_mass_H2O, -1.0E-7, " expected mass H2O error ::")
       self.testLT(final_total_mass_CO2 - self.total_mass_CO2, -1.0E-4, " expected mass CO2 error ::")

    """ This is where you setup all your getters/setters for the parameters you need for int testing.
    """
    # Getter for number of nodes
    def getNumNodes(self):
        return massOverflow.fluid14err.getNumLocalNodes() - 1
    # Getter for node
    def node(self,node):
        return massOverflow.fluid14err.netNodes[node]
