...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 25
#===============================================================================================
class TestOverflow25(Test):
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow25, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow25, self).setup()
    ...
    def checkNodesInitState(self):
       sorb13ads_mass = massOverflow.fluid25.sorb13ads.getAdsorbedMass()
       sorb13des_mass = massOverflow.fluid25.sorb13des.getAdsorbedMass()
       sorb23ads_mass = massOverflow.fluid25.sorb23ads.getAdsorbedMass()
       sorb23des_mass = massOverflow.fluid25.sorb23des.getAdsorbedMass()
       self.total_mass     = self.total_mass + sorb13ads_mass + sorb13des_mass + sorb23ads_mass + sorb23des_mass
    ...
    def checkNodesFinalState(self):
       ...
       sorb23ads_mass = massOverflow.fluid25.sorb23ads.getAdsorbedMass()
       sorb23des_mass = massOverflow.fluid25.sorb23des.getAdsorbedMass()
       final_total_mass     = sorb13ads_mass + sorb13des_mass + sorb23ads_mass + sorb23des_mass
