...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 30
#===============================================================================================
class TestOverflow30(Test):
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow30, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow30, self).setup()
    ...
    def checkNodesFinalState(self):
       ...
       for node in range(0,self.getNumNodes()):
          ...
          final_total_mass_respiration = (final_total_mass_O2  - self.total_mass_O2) + (final_total_mass_H2O  - self.total_mass_H2O + final_total_mass_CO2  - self.total_mass_CO2)
       ...
       # Enthalpy testing is commented out because the link being tested (metabolics2) does not conserve energy
       ...
       self.testNear(final_total_mass_respiration,               0.0, (1.0E-16 + tolerance * self.total_mass_O2),  " mass Human Respiration error fraction ::")

    """ This is where you setup all your getters/setters for the parameters you need for int testing.
    """
    # Getter for number of nodes
    def getNumNodes(self):
        return massOverflow.fluid30.getNumLocalNodes() - 1
    # Getter for node
    def node(self,node):
        return massOverflow.fluid30.netNodes[node]
