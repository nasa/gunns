...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 31
#===============================================================================================
class TestOverflow31(Test):
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow31, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow31, self).setup()
    ...
    def checkNodesFinalState(self):
       ...
       final_total_mass_combustion = 0.0;
       ...
       for node in range(0,self.getNumNodes()):
          ...
          final_total_mass_combustion = (final_total_mass_O2  - self.total_mass_O2) + (final_total_mass_H2O  - self.total_mass_H2O + final_total_mass_CO2  - self.total_mass_CO2)

       print("-------------------------------------------------------------------------------------------------")
       # Comparing relative error (final - start / start) to tolerance
       # Combustion is tested for fireSource link to ensure accurate burn qualities
       # Enthalpy testing is commented out because the link being tested (FireSource) does not conserve energy
       ...
       self.testNear(final_total_mass_combustion,               0.0, (1.0E-16 + tolerance * self.total_mass_O2),  " mass combustion error fraction ::")

    """ This is where you setup all your getters/setters for the parameters you need for int testing.
    """
    # Getter for number of nodes
    def getNumNodes(self):
        return massOverflow.fluid31.getNumLocalNodes() - 1
    # Getter for node
    def node(self,node):
        return massOverflow.fluid31.netNodes[node]
