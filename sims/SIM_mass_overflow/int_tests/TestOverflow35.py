...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 35
#===============================================================================================
class TestOverflow35(Test):
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow35, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow35, self).setup()
    ...
    def checkNodesInitState(self):
       sorb13ad_mass  = float (massOverflow.fluid35.msorb13ad.mCompounds[0].mAdsorbedMass)
       sorb13des_mass = float (massOverflow.fluid35.msorb13des.mCompounds[0].mAdsorbedMass)
       self.total_mass     = self.total_mass + sorb13ad_mass + sorb13des_mass
       self.total_mass_H2O = self.total_mass_H2O + sorb13ad_mass
       self.total_mass_CO2 = self.total_mass_CO2 + sorb13des_mass
    ...
    def checkNodesFinalState(self):
       sorb13ad_mass  = float (massOverflow.fluid35.msorb13ad.mCompounds[0].mAdsorbedMass)
       sorb13des_mass = float (massOverflow.fluid35.msorb13des.mCompounds[0].mAdsorbedMass)
       final_total_mass     = sorb13ad_mass + sorb13des_mass
