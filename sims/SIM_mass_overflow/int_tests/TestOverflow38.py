...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 38
#===============================================================================================
class TestOverflow38(Test):
   ...
   # total_enthalpy = 0.0
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow38, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow38, self).setup()
    ...
    def checkNodesFinalState(self):
       ...
       final_total_mass_CO2 = - (source2_mass) * self.nodeMassFraction(2, "GUNNS_CO2")
