...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 40
#===============================================================================================
class TestOverflow40(Test):
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow40, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow40, self).setup()
    ...
    def checkNodesInitState(self):
       rca12CO2_mass  = float (massOverflow.fluid40.rca12.mCompounds[0].mAdsorbedMass)
       rca12H2O_mass  = float (massOverflow.fluid40.rca12.mCompounds[1].mAdsorbedMass)
       rca45CO2_mass  = float (massOverflow.fluid40.rca45.mCompounds[0].mAdsorbedMass)
       rca45H2O_mass  = float (massOverflow.fluid40.rca45.mCompounds[1].mAdsorbedMass)

       self.total_mass_ad      = self.total_mass_ad  + rca12H2O_mass  + rca12CO2_mass
       self.total_mass_H2O_ad  = self.total_mass_H2O_ad  + rca12H2O_mass
       self.total_mass_CO2_ad  = self.total_mass_CO2_ad + rca12CO2_mass
       self.temperature_ad    = self.nodeTemperature(0)

       self.total_mass_des     = self.total_mass_des - rca45H2O_mass  - rca45CO2_mass
       self.total_mass_H2O_des = self.total_mass_H2O_des - rca45H2O_mass
       self.total_mass_CO2_des = self.total_mass_CO2_des - rca45CO2_mass
    ...
    def checkNodesFinalState(self):
       rca12CO2_mass  = float (massOverflow.fluid40.rca12.mCompounds[0].mAdsorbedMass)
       rca12H2O_mass  = float (massOverflow.fluid40.rca12.mCompounds[1].mAdsorbedMass)
       rca45CO2_mass  = 0.02 - float (massOverflow.fluid40.rca45.mCompounds[0].mAdsorbedMass)
       rca45H2O_mass  = 0.01 - float (massOverflow.fluid40.rca45.mCompounds[1].mAdsorbedMass)

       final_total_mass_ad      = rca12H2O_mass + rca12CO2_mass
       final_total_mass_N2_ad   = 0.0
       final_total_mass_O2_ad   = 0.0
       final_total_mass_H2O_ad  = rca12H2O_mass
       final_total_mass_CO2_ad  = rca12CO2_mass
       final_temperature_ad     = self.nodeTemperature(0)

       final_total_mass_des     = - (rca45H2O_mass + rca45CO2_mass)
       final_total_mass_N2_des  = 0.0
       final_total_mass_O2_des  = 0.0
       final_total_mass_H2O_des = - rca45H2O_mass
       final_total_mass_CO2_des = - rca45CO2_mass
    ...
    def getNumNodes(self):
        return massOverflow.fluid40.getNumLocalNodes() - 1
    # Getter for node
    def node(self,node):
        return massOverflow.fluid40.netNodes[node]
