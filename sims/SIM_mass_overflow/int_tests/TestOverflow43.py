...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 43
#===============================================================================================
class TestOverflow43(Test):
 ...
 #   total_enthalpy = 0.0
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow43, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow43, self).setup()
    ...
    def checkNodesFinalState(self):
      ...
      # final_total_enthalpy = - heatProduced
       ...
       # Enthalpy testing is commented out because the link being tested (metabolics4) does not conserve energy
