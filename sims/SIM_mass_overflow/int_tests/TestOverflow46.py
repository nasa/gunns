...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 46
#===============================================================================================
class TestOverflow46(Test):
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow46, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow46, self).setup()
    ...
    def checkNodesInitState(self):
       sorb12adH2O_mass  = float (massOverflow.fluid46.sorb12ad.getAdsorbedMass())
       sorb45deH2O_mass  = float (massOverflow.fluid46.sorb45de.getAdsorbedMass())
    ...
    def getNumNodes(self):
        return massOverflow.fluid46.getNumLocalNodes() - 1
    # Getter for node
    def node(self,node):
        return massOverflow.fluid46.netNodes[node]
