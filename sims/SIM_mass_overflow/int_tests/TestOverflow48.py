...
#===============================================================================================
# GUNNS SIM_mass_overflow Test 48
#===============================================================================================
class TestOverflow48(Test):
    ...
    def __init__(self, testName, testStartMessage, testFinishMessage):
       ...
       super(TestOverflow48, self).__init__(testName, testStartMessage, testFinishMessage)
    ...
    def setup(self):
       ...
       super(TestOverflow48, self).setup()
    ...
    def checkNodesInitState(self):
       ...
       self.check = sorb45des_mass
       self.total_mass_ad      = self.total_mass_ad     + sorb12ad_mass
       self.total_mass_H2O_ad  = self.total_mass_H2O_ad + sorb12ad_mass
       self.total_mass_CO2_ad  = self.total_mass_CO2_ad
       self.temperature_ad    = self.nodeTemperature(0)

       self.total_mass_des     = self.total_mass_des     + sorb45des_mass
       self.total_mass_H2O_des = self.total_mass_H2O_des
       self.total_mass_CO2_des = self.total_mass_CO2_des + sorb45des_mass
    ...
    def checkNodesFinalState(self):
       ...
       final_total_mass_H2O_ad  = sorb12ad_mass
