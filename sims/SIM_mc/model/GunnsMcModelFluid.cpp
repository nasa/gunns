...
PROGRAMMERS:
  ((Auto-generated by the GunnsDraw netexport script version 19.5.0) (2024-09-23 07:58:46.875610))
*/
...
GunnsMcModelFluidConfigData::GunnsMcModelFluidConfigData(const std::string& name, GunnsMcModelFluid* network)
    ...
    tank(name + ".tank", &network->netNodeList, 0.5, 0.0, 0.0, 1.0e-6, 4.83, 0.62),
    conductor3(name + ".conductor3", &network->netNodeList, 0.0001, 0.0)
{
...
GunnsMcModelFluidInputData::GunnsMcModelFluidInputData(GunnsMcModelFluid* network)
    ...
    tank(false, 0.0, 1.0, &fluidDefault, 294.261, 0.0),
    conductor3(false, 0.0)
{
...
void GunnsMcModelFluid::initNetwork()
{
    ...
    conductor3.initialize(netConfig.conductor3, netInput.conductor3, netLinks, Node2 + netSuperNodesOffset, GROUND + groundOffset);
