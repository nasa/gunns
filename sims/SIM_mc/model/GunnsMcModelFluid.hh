...
class GunnsMcModelFluidConfigData
{
    public:
        ...
        GunnsFluidPotentialConfigData pressureSource;    /**< (--) trick_chkpnt_io(**) pressureSource config data. */
...
class GunnsMcModelFluidInputData
{
    public:
        ...
        // Spotters input data
        // Links input data
        GunnsFluidPotentialInputData pressureSource;    /**< (--) trick_chkpnt_io(**) pressureSource input data. */
...
class GunnsMcModelFluid : public GunnsNetworkBase
{
    ...
    public:
        ...
        // Spotters
        // Links
        GunnsFluidPotential pressureSource;    /**< (--) pressureSource instance. */
