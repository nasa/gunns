...
def write_epoch_config(epoch, distribution, inertia, seed):
    render = "# This is auto-generated by the PSO swarm manager script, defining the\n" \
           ...
           + "#\n" \
           + "mc.monteCarlo.mOptimizer.mConfigData.mRandomSeed       = " + str(seed) + "\n" \
           + "mc.monteCarlo.mOptimizer.mConfigData.mInertiaWeight    = " + str(inertia) + "\n" \
           + "mc.monteCarlo.mOptimizer.mConfigData.mInertiaWeightEnd = " + str(inertia) + "\n" \
           + "mc.monteCarlo.mOptimizer.mConfigData.mInitDistribution = trick.GunnsMonteCarloPsoConfigData." + distribution + "\n"
